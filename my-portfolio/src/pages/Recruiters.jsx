  ...
  return (
    <div className="recruiters-bg-container">
      ...
      <div className="recruiters-overlay">
        <p>I’m Abhay Kumar, a Computer Engineering student at IADE Lisbon (graduating July 2025) with a strong foundation in full-stack web and Android development.
        ...
        <div className="recruiters-buttons">
          <button onClick={handleShowCV}>Show My CV</button>
